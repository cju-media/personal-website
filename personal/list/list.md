...
A lot of changes at work. A member of my team is leaving and the choir director is leaving.

I have some thoughts but I promised my wife I was going to bed soon so I am not going to stay up much more. Just wanted to get a post in today.
...
I am on a composition roll as of late. I submitted to two things this past week, one of which being an original piece for solo clarinet. I also revamped my originals page to have a nice modal like THE WAY. I just got way distracted adding a couple of pieces I have worked on over the years into that folder. The dynamic nature of it all works nice and I am designing the site to conform to my workflow. For example I am giting everything now. Max, dorico files, everything. I work on pieces in my WIP folder, which is under my scores repo. When the piece is finished I move it to my originals folder. Once I push the commit my website will automatically update with the new piece. That way I do not need to go out of my way to update my site manually. Because it is all apart of my nautral workflow, I will never forget to update my site in a timely matter with the piece I am working on. My site will never appear dead, it will be constantly updating with new works. 


## 5-4-26
Welcome to the beautiful month of May.

I had some screen scoring thoughts recently. Every film for the entirety of the existence of film has been scored by the orchesta. Since it was possible to put audio to film the orchestra has been the medium in which music has been expressed on the screen. Part of the reason is that the orchestra was the instrument that provided the widest variety of timbres. It was an existing medium with people trained to perform in it. Finding performers is very simple. If a composer experimented with a different type of ensemble then they risk set backs, increased costs and time to get the score to the picture. Economic and cultural pressures pushed composers to choose the orchestra.

That has broken in the modern times. Now that more and more composers start in DAWs than on staff paper the medium in which film composers choose to write in has changed. The DAW has been the real medium of film composition for over 2 decades now. Especially as sample libraries and physical modeling has improved so that low cost DAW production becomes sutiable for low budget productions, the DAW has become the instrument for media scores in the modern age. 

Since less and less composers start classically trained and work more and more with the language of the DAW and modern music production, the historic weight of the orchestra begins to lighten. You do not even need the orchestra to produced a finished score for a film. You can do it all in the DAW. Why do composers need to work within the restraints of the orchestra when the DAW gives you more flexibility with no downsides? A DAW produced score can sound just as good as a live orchestra score. 

I would argue that traditional orchestra scores sound **dated.** Thinking of the most notable film scores of the past half decade I gravitate towards the scores that have existed outside the traditional orchestra arrangement. Oppenheimer comes to mind. And that score was noticed for being different. It stood out from the crowd BECAUSE it is different. Another example is the [Zelda Tears of the Kingdom Trailer](https://www.youtube.com/watch?v=uHGShqcAHlQ). Although there is an orchestra the composer uses a sax to carry the melody, very cool reverse vocal lines and non-western string instuments. The music stands out because it is not generic. Challengers is a another notable example. All 80s synths. I think we live in a time where getting access to an orchestra will become more and more out of reach for more and more projects. All to make your score sound generic. You can have a far more interesting sounding score without the cost and time to invest in a full orchestra recording.

A few years ago there was a quite public competition to rescore a scene from the Westworld show. There was a huge uproar about the winner. So many participant complained that they hated the winner. Some even shared their own submission as proof that the competition was rigged in some way? Let me say every submission I saw was a John Williams rip-off mickey-moused to hell and back. These young film composers that spent their lives listening to their film score professors profess that John Williams-esque scores were the end-all-be-all of media music. They all sounded exactly the same, were bland and uninteresting. The winning score? Something new and interesting. People can notice it. Composers who refuse to change with the times are left in the dust.

I think the future is in weird scores. Weird timbrally, not harmonically. Do you want to stand out? Score a cue with a sax quartet.
...
Since I graduated, I have been waiting and waiting for my real career to start. My real artistic journey. Where is that? What work have I put in. What progress have I really made? That first year or two I did a couple of festivals. I did not gain any satisfication from those experiences. Although realistically I probably did not take the most advantage of those events, I think there was a reason for that. Do I even enjoy art? Do I have it in me to create something good? Something meaningful.
...
It’s based on an Oscar Wilde play of the same title. I’m sure the content originated from some myth. The entire opening/overture was monophonic. Almost no orchestration at all, just everyone playing the same notes. The full work I think lacked musicality. Although once we got into the opera proper there was some interesting orchestration which kept me entertained. The composer had a reliance on having a solo instrument double the singer. Especially at the beginning, which low voices it was especially hard to hear. The doubled instrument just completely covered the singers. 

I do want to speak on the economy of the work. How did the composer use all of his tools and did he use them efficiently. There were two percussionists (well one plus a timpanist) and I think they both played once in the hour long work. The two featured characters in the opening did not have any role after that point for the most part. They sang but they didn’t really act as a character. Just speaking of the arc of the whole work when half the cast disappear and never return I don’t really like. How can characters have arcs when they don’t have the time to have an arc. Compare that to Kantan. The characters represent something and necessarily don’t have an arc BUT they exist through the whole work. That’s economy. 

Anyway tired. Peace.

## 3-23-26
I did some work and managed to put together a [video](https://www.youtube.com/watch?v=m369CLOA5P8&feature=youtu.be) for my [Stream Chat Highlight](https://github.com/cju-media/Stream-Chat-Highlight) device. The overall architecture of the program is my most adavanced yet. A node server collects all of the chat messages and dishes it out to a dashboard via a websocket. Clicking on any of these chat messages sends it to an overlay that displays it on the stream. The dashboard can filter by chat, and a column appears to display new messages from a highlighted chatter. I am very happy how it turned out and I got some experience exporting node as a standalone app, which may be a replacement for Max in the future. One of the primary reasons to use Max is that it can host node. For example, in my shatto control patch I am using max to host a node script to control home assistant enabled lights from DMX commands. I could potentially replace Max with standalone node script but the DMX might present a problem. I cannot dynamically change DMX mapping. Maybe if I built a web interface that can handle that. But Max has a certain elegance that I like.

Have I met my quota for the day? Its hard to have the equivelant of 3 pages in this endless markdown file. I cannot measure based on lines because each paragraph is one line. I cannot see the amount of sentences I have written easily. And. That. Can. Be. Abused. Easily. I mean just get a small notebook and each page would be short. There are ways to cheat a three pages if you are truly feeling lazy. But that kind of defeats the point of an excersize like this. It is supposed to be discipline. You are supposed to build the habit of writing no matter what. That was the lesson I learned from Glass's book on his three Portrait Operas, *Operas on the Beach*. Or maybe it was *Words Without Music*? He atributted his success to his work ethic compared to his peers. This is a process of building that work ethic. 

Maybe I do have ADHD. I just stopped in the middle of writing THE LIST to do a way. I need to focus at one thing at time. As I go through this work ethic journey I feel my ADHD getting worse. At least brainrot would calm my mind enought to concentrate or "concentrate" on one thing.

## 3-21-26
I am on a mission to try and figure out how to get chat audio from my xbox into my stream. Microsoft, in their infinite wisdom has completely blocked chat audio from outputting to HDMI audio. I tried a few things, including doing remote play on my computer to send the audio there. Latency is insane so it is impossible to play that way. Even if it works sending audio to my computer, the streaming KILLS my framerate. Under 30 fps easy. It seems like my only option is to switch to a wired headset, get a [chat link pro](https://www.amazon.com/YEAOI-HD60-Chat-Link-Pro/dp/B0BB98R1T5/ref=sr_1_2_sspa?crid=3JS2F47KHIG0I&dib=eyJ2IjoiMSJ9.En0MoOf0_1B9H_o2N6BPU_PFMDpZYJmeaqq_PddbnzTSuM_BTo4tVrXqkdte_x4LKhuC_bChfsbgWFjiuMOJZZWQNUboSIwM91SXXAqWWq74vRlKc6cYf1JcV0sN5LswK68VgpYdGsoIKwAOreZVk9J6H5HvMAZEG8iL66KSiHntOCtRpQUnf9rfjrAqJRaH92m2E9lKw1BP9Uw4DOe76y95GLJ0ADNjjuZLB9OFhwI.pWhUcGvZ4fqQUk7xTgTUR8z3UjROED6KpYDSyiOw4Zo&dib_tag=se&keywords=elgato%2Bchat%2Blink%2Bpro%2Bxbox&qid=1774157541&sprefix=elgato%2Bchat%2Blink%2Bpro%2B%2Caps%2C192&sr=8-2-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&th=1) to split my headset audio to the audio input of my capture card. Good news it seems that the Xbox controller outputs both game and chat audio. Problem I have now is  will have double game audio (via HDMI and audio input of capture card). So I have to think of a way to avoid that. Potentially having a whole new interface for the the game output. 

So [IEM with mic](https://www.amazon.com/DC03-Headphones-Cancelling-Earphones-Detachable/dp/B0DWFNMXWY/ref=sr_1_9?crid=OFH7Y65MNZP&dib=eyJ2IjoiMSJ9.AoRmu73pd1c6wM_HlvlPFpnCKGcjWCFKdIz06BT6MSo1ybrZ5Q6nhhdVW8DK8dQ7AH3k5DmZZluwb_PrIXei-9C6G7OJUy5yyQnABCycn64cmCguhC9OedNG-CMq_t_HU075NbE9DVd-7DLPCW2DxwTWIZoc3O7Y5_QcrWFkbFGEtfyvh4oRe9tehnaQyaSUiZAJBbIKNabYfhhDKzmRLqgoZpE-FUqynsNAESrnS24.Py-YWrvlWpSvcsn0r_A5KgusRNhje2x4ZVjdTy8FWVw&dib_tag=se&keywords=iem%2Bwith%2Bmic&qid=1774158478&sprefix=iem%2Bwith%2Bm%2Caps%2C193&sr=8-9&th=1) for monitoring and a [chat link pro](https://www.amazon.com/YEAOI-HD60-Chat-Link-Pro/dp/B0BB98R1T5/ref=sr_1_2_sspa?crid=3JS2F47KHIG0I&dib=eyJ2IjoiMSJ9.En0MoOf0_1B9H_o2N6BPU_PFMDpZYJmeaqq_PddbnzTSuM_BTo4tVrXqkdte_x4LKhuC_bChfsbgWFjiuMOJZZWQNUboSIwM91SXXAqWWq74vRlKc6cYf1JcV0sN5LswK68VgpYdGsoIKwAOreZVk9J6H5HvMAZEG8iL66KSiHntOCtRpQUnf9rfjrAqJRaH92m2E9lKw1BP9Uw4DOe76y95GLJ0ADNjjuZLB9OFhwI.pWhUcGvZ4fqQUk7xTgTUR8z3UjROED6KpYDSyiOw4Zo&dib_tag=se&keywords=elgato%2Bchat%2Blink%2Bpro%2Bxbox&qid=1774157541&sprefix=elgato%2Bchat%2Blink%2Bpro%2B%2Caps%2C192&sr=8-2-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&th=1) to send audio into a [cheapie USBC interface](https://www.amazon.com/External-Headphone-Microphone-Compatible-Desktops/dp/B0FMF1216M/ref=sr_1_17?crid=E6QXDR8N8L6B&dib=eyJ2IjoiMSJ9.cpB_HydE_LsIAZQ7Rsm--4Q0otPcIhT-KCPAiAxOXIeEJMansRSss4PnmZj5vCq2s5-3CD3ch0Tf472k9CDrau4dqOnHn9kkcitJEkXlJ0wbIVmWE_SLAWvV1fU_I4Tq19ZCtUEbXyTAU96LaiQ6u2QGi11h-ynBT9_9hzDcAo9CIzISan41_8x6tI3xZarvaT1qFnGl5L95bvmcGFk--nWqrKtbQ_z9S39W050OZbBKyTCdHm0GCHnR8yOERWYlQELixtSMA3jCxB1NwfmP-uj-8A99-SwzQd0bjc6G-Vg.BMh8J_DusuuXBUlPC1iKdUyPuqRx398fP8bLIOcXtjI&dib_tag=se&keywords=usb%2Bc%2Baudio%2Binterface&qid=1774159569&sprefix=usb%2Bc%2Baudio%2Binter%2Caps%2C231&sr=8-17&th=1) to divorce the HDMI audio from the controller audio. That avoids the double audio issue completely. So a little bit of an investmetn but I guess its less than buying a whole new PC. 

I worked a lot on my dub of Atrioc's chat highlight. When he wantes to yell at someone in chat, he can click on the message and it will pull up on his stream. I rebuilt it and added Youtube integration for multistreamers. Its quite sophisticated, using a node server, dashboard and overlay for OBS. The dashboard can live in OBS too for easy use. The only thing I am unhappy about is the user has to launch the server via a terminal app. I would hope to have the server live in OBS but I think that would require OBS scripting via python. That is a bit troublesome to work with. Opting for the package build of the node script was something that I thought would be most straight forward for the user. Considering that users can set up the overlay and the dashboard IN OBS, they will only have to open one thing. If I could have it easily launch with OBS I would.
...
![THE SET](https://github.com/cju-media/personal-website/blob/main/personal/list/images/3-1-26.jpeg?raw=true)
...
Went to Disney today. Kayla was very concerned about the upending of the bricks lining the entrance to her community. She’s 18 so maybe this is the first time she is old enough to notice a dramatic long term change. Perhaps that’s the reason it had such an effect on her. It’s proof that nothing, even as foundations as brick, is immune from change

## 2-6-26  
*[Variations for Winds, Strings, and Keyboards](https://youtu.be/1p2XXxO7gyE?si=xURDa8wdcdU3U33o)- Steve Reich*  

Harmonically very simple with some density throughout that is quite attractive. He had explicit roles for the instrumentation that held firm, not even playing with expectations. Woodwinds and strings doing all he fast subdivided notes and constanly evolving patterns and low voices and brass hitting all of these intense pedals and stings. It does not get borning for being in one key center and lasting 20+ minutes.  
